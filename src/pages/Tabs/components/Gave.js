...
const Gave = () => {
    ...
    return fetch(`${configData.SERVER_URL}/toy/myGiftToys`, {
      method: 'get',
      headers: {
      ...
      const renderItem = ({ item }) => (
        ...
        <View style={styles.toyBox}>
           <View style={styles.boxTop}>
                ...
                <View>
                   <Icon name={'check-circle'} size={width / 12} style={{ color: "#1EAD13" }} />
                </View>
           </View>
...
<View style={styles.boxTwo}>
  ...
  {/* <Text style={{fontSize:width/25, marginTop:width/40, color:"#000", textAlign: "center"}}>Toys i have given</Text> */}
