...
const ToyDetails = ({route}) => {

    const { data, owner } = route.params;
            ...
            <View style={styles.boxOne}>
                ...
                <View style={styles.toyBox}>
                    <View style={styles.boxTop}>
                        ...
                        uri: `${configData.PIC_URL}/${data.owner.profImage}`}} alt="profile" />
                            <Text style={styles.userName}>{data.owner.firstName}</Text>
                        </TouchableOpacity>
                        <View>
                            <Text style={styles.toyStatus}>{data.toyState}</Text>
                        </View>
                    
                     </View>
                    <View style={styles.middleBox}>
                        <Image  source={{uri:`${configData.PIC_URL}/${data.imageOne}`}}  style={{ resizeMode: 'contain', width:"100%", height:"100%" }}  alt="Toy image"/>
                     </View>
                    </View>
                    ...
                    <View style={styles.description}>
                        ...
                        {owner === "yes" ? <></> : <>
                         ...
                         <View style={styles.details}>
                             <Text style={styles.toyName}>{data.title}</Text>
                        {isActive ? 
                             <View>
                                ...
                                <View style={{borderBottomWidth:2, borderBottomColor:"#E8EAED", borderTopWidth:2, borderTopColor:"#E8EAED", paddingTop:width/20, paddingBottom:width/20, justifyContent:"center", alignItems: "center"}}>
                                    ...
                                    <Text style={{color:"#6654A8", fontSize:width/32, marginTop:width/20}}>For ages: {data.ageRange} </Text>
